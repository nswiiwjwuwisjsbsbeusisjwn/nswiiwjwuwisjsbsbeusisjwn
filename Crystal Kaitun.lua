        ...
        if tostring(method) == "FireServer" then
            if tostring(args[1]) == "RemoteEvent" then
                if tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then
                    if
                        (_G.FarmMastery_G and not SoulGuitar) or (_G.FarmMastery_Dev) or (_G.FarmBlazeEM) or
                            (_G.Prehis_Skills) or
                            (_G.SeaBeast1 or _G.FishBoat or _G.PGB or _G.Leviathan1 or _G.Complete_Trials) or
    ...
    for _, v4 in pairs(replicated.Remotes.CommF_:InvokeServer("getInventory")) do
        if type(v4) == "table" then
            if v4.Type == "Sword" then
                if
                    v4.Name == nametool or plr.Character:FindFirstChild(nametool) or
                        plr.Backpack:FindFirstChild(nametool)
                 then
                    return true
                end
            end
    ...
    function()
        while task.wait() do
            pcall(
                function()
                    if
                        _G.SailBoat_Hydra or _G.WardenBoss or _G.AutoFactory or _G.HighestMirage or _G.HCM or _G.PGB or
                            _G.Leviathan1 or
                            _G.UPGDrago or
...
QuestCheck = function()
    ...
    elseif World2 then
        ...
        elseif a == 1350 or a <= 1374 then
            ...
            if
                _G.Level and
                    (PosQ.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 1000
             then
                BTP(PosM)
            end
                        ...
                        elseif plr.PlayerGui.Main.Quest.Visible == true then
                            if workspace.Enemies:FindFirstChild(QuestNeta()[1]) then
                                    ...
                                    if Attack.Alive(v) then
                                        if v.Name == QuestNeta()[1] then
                                            if string.find(QuestTitle, QuestNeta()[5]) then
                                                ...
                                                until not _G.Level or v.Humanoid.Health <= 0 or not v.Parent or
                                                    plr.PlayerGui.Main.Quest.Visible == false
                                            else
                                                replicated.Remotes.CommF_:InvokeServer("AbandonQuest")
                                            end
                                        end
                                ...
                                if replicated:FindFirstChild(QuestNeta()[1]) then
                                    topos(
                                        replicated:FindFirstChild(QuestNeta()[1]).HumanoidRootPart.CFrame *
                                            CFrame.new(0, 30, 0)
                                    )
                                end
                            end
    ...
    function()
        while wait(.2) do
            pcall(
                function()
                    if
                        _G.AutoSaber and plr.Data.Level.Value >= 200 and not plr.Backpack:FindFirstChild("Saber") and
                            not plr.Character:FindFirstChild("Saber")
                     then
                        _G.Level = false
                        if workspace.Map.Jungle.Final.Part.Transparency == 0 then
                            if workspace.Map.Jungle.QuestPlates.Door.Transparency == 0 then
                                if
                                    (CFrame.new(
                                        ...
                                        -4.39869794e-08,
                                        0.37091279
                                    ).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 100
                                 then
                                ...
                                if workspace.Map.Desert.Burn.Part.Transparency == 0 then
                                    ...
                                    if replicated.Remotes.CommF_:InvokeServer("ProQuestProgress", "SickMan") ~= 0 then
                                        ...
                                        elseif
                                            replicated.Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon") == 0
                                         then
                                            if
                                                workspace.Enemies:FindFirstChild("Mob Leader") or
                                                    replicated:FindFirstChild("Mob Leader")
                                             then
                                                topos(
                                                    CFrame.new(
                                                        -2967.59521,
                                        ...
                                        elseif
                                            replicated.Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon") == 1
                                         then
                                            replicated.Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon")
                                            EquipWeapon("Relic")
                                            topos(
                            ...
                            if
                                workspace.Enemies:FindFirstChild("Saber Expert") or
                                    replicated:FindFirstChild("Saber Expert")
                             then
                                for _, v in pairs(workspace.Enemies:GetChildren()) do
...
if plr.Data.Level.Value >= 700 and World1 then
    _G.AutoZou = true
    _G.Level = false
end
                    ...
                    if _G.TravelDres then
                        if plr.Data.Level.Value >= 700 then
                            if workspace.Map.Ice.Door.CanCollide == true and workspace.Map.Ice.Door.Transparency == 0 then
                                ...
                                until not _G.TravelDres or
                                    (Root.Position == CFrame.new(1347.7124, 37.3751602, -1325.6488).Position)
                            elseif
                                workspace.Map.Ice.Door.CanCollide == false and workspace.Map.Ice.Door.Transparency == 1
                             then
...
if plr.Data.Level.Value >= 1500 and World2 then
    _G.AutoZou = true
    _G.Level = false
end
                        ...
                        if plr.Data.Level.Value >= 1500 then
                            if replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 3 then
                                if replicated.Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ~= nil then
                                    ...
                                    elseif replicated.Remotes["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 1 then
                                        ...
                                        if v then
                                            ...
                                            until not _G.AutoZou or
                                                (Root.Position == CFrame.new(2288.802, 15.1870775, 863.034607).Position)
                                    ...
                                    if replicated.Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil then
                                        ...
                                        TabelDevilFruitOpen = {}
                                        for i, v in pairs(
                                            replicated.Remotes["CommF_"]:InvokeServer("getInventoryFruits")
                                        ) do
                                        ...
                                        for i, v in next, game.ReplicatedStorage:WaitForChild("Remotes").CommF_:InvokeServer(
                                            "GetFruits"
                                        ) do
                                        ...
                                        for i, DevilFruitOpenDoor in pairs(TabelDevilFruitOpen) do
                                            for i1, DevilFruitStore in pairs(TabelDevilFruitStore) do
                                                if
                                                    DevilFruitOpenDoor == DevilFruitStore and
                                                        replicated.Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ==
                                                            nil
                                                 then
                                ...
                                if replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
                                    if
                                        string.find(
                                            plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,
                                            "Swan Pirates"
                                        ) and
                                            string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and
                                            plr.PlayerGui.Main.Quest.Visible == true
                                     then
                                            ...
                                            pcall(
                                                function()
                                                    repeat
                                                        wait()
                                                        Attack.Kill(v, _G.AutoZou)
                                                    until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoZou == false or
                                                        plr.PlayerGui.Main.Quest.Visible == false
                                                end
                                            )
                                        else
    ...
    function()
        while wait(0.2) do
            pcall(
                function()
                    if
                        replicated:FindFirstChild("Diablo") or replicated:FindFirstChild("Deandre") or
                            ...
                            game.Workspace.Enemies:FindFirstChild("Urban")
                     then
                ...
                function()
                    if _G.FarmEliteHunt then
                        if plr.PlayerGui.Main.Quest.Visible == true then
                            if
                                string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Diablo") or
                                    string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Urban") or
                                    string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Deandre")
                             then
                                for i, v in pairs(replicated:GetChildren()) do
                                    if
                                        string.find(v.Name, "Diablo") or string.find(v.Name, "Urban") or
                                            string.find(v.Name, "Deandre")
                                     then
                                ...
                                for i, v in pairs(Enemies:GetChildren()) do
                                    if
                                        (string.find(v.Name, "Diablo") or string.find(v.Name, "Urban") or
                                            string.find(v.Name, "Deandre")) and
                                            Attack.Alive(v)
                                     then
                                        repeat
                                            wait()
                                            Attack.Kill(v, _G.FarmEliteHunt)
                                        until not _G.FarmEliteHunt or plr.PlayerGui.Main.Quest.Visible == false or
                                            not v.Parent or
                                            v.Humanoid.Health <= 0
                                    end
                                end
...
spawn(
    function()
        while wait(0.2) do
            pcall(
                function()
                    if replicated:FindFirstChild("Dough King") then
                        _G.AutoMiror = true
                        _G.Level = false
                    else
                        _G.Level = true
                    ...
                    function()
                        ...
                        if bone then
                            if _G.AcceptQuestC and not questUI.Visible then
                                local questPos =
                                    CFrame.new(-9516.99316, 172.017181, 6078.46533, 0, 0, -1, 0, 1, 0, 1, 0, 0)
                                topos(questPos)
                            ...
                            until not _G.AutoFarm_Bone or bone.Humanoid.Health <= 0 or not bone.Parent or
                                (_G.AcceptQuestC and not questUI.Visible)
                        else
                            topos(CFrame.new(-9495.6806640625, 453.58624267578125, 5977.3486328125))
                        end
                    end
                )
            end
...
if _G.Godhuman then
    if GetBP("Superhuman") or GetBP("Superhuman").Level.Value >= 400 then
        _G.AutoDeathStep = true
        _G.Auto_SuperHuman = false
    end
    if GetBP("Death Step") or GetBP("Death Step").Level.Value >= 400 then
        _G.Auto_SharkMan_Karate = true
        _G.AutoDeathStep = false
    end
    if GetBP("Sharkman Karate") or GetBP("Sharkman Karate").Level.Value >= 400 then
        _G.Auto_Electric_Claw = true
        _G.Auto_SharkMan_Karate = false
    end
    if GetBP("Electric Claw") or GetBP("Electric Claw").Level.Value >= 400 then
        _G.AutoDragonTalon = true
        _G.Auto_Electric_Claw = false
    end
    if GetBP("Dragon Talon") or GetBP("Dragon Talon").Level.Value >= 400 then
                                ...
                                if GetBP("Black Leg") or GetBP("Black Leg").Level.Value >= 400 then
                                    if workspace.Map.IceCastle.Hall.LibraryDoor.PhoeyuDoor.Transparency == 0 then
                                        if GetBP("Library Key") then
                                            ...
                                            until not _G.AutoDeathStep or
                                                (Root.Position ==
                                                    CFrame.new(6371.2001953125, 296.63433837890625, -6841.18115234375).Position)
                                            if
                                                (Root.CFrame ==
                                                    CFrame.new(6371.2001953125, 296.63433837890625, -6841.18115234375))
                                             then
                                                replicated.Remotes.CommF_:InvokeServer("BuyDeathStep")
                                            end
                                ...
                                if GetBP("Fishman Karate") or GetBP("Fishman Karate").Level.Value >= 400 then
                                        ...
                                        if
                                         ...
                                         then
                                            if GetBP("Water Key") then
                                                ...
                                                until not _G.Auto_SharkMan_Karate or
                                                    (Root.Position ==
                                                        CFrame.new(
                                                            -2604.6958,
                                                            239.432526,
                                    ...
                                    elseif not GetBP("Water Key") then
                                        ...
                                        if v then
                                            ...
                                            until not v.Parent or v.Humanoid.Health <= 0 or
                                                _G.Auto_SharkMan_Karate == false or
                                                GetBP("Water Key") or
                                                GetBP("Sharkman Karate")
                                        else
                    ...
                    if _G.AutoGodHuman then
                        if
                            replicated.Remotes.CommF_:InvokeServer("BuyGodhuman", true) ==
                                "Bring me 20 Fish Tails, 20 Magma Ore, 10 Dragon Scales and 10 Mystic Droplets."
                         then
...
if _G.Stats then
    _G.Auto_Melee = true
elseif _G.Stats and game.Players.LocalPlayer.Data.Stats.Melee.Level.Value >= 2550 then
    _G.Auto_Defense = true
elseif _G.Stats and game.Players.LocalPlayer.Data.Stats.Melee.Defense.Value >= 2550 then
    _G.Auto_Sword = true
end
...
elseif game.Players.LocalPlayer.Data.Beli.Value >= 100000 then
    ...
    warn("Bought Soru")
elseif game.Players.LocalPlayer.Data.Beli.Value >= 750000 then
...
function AttackNoCoolDown()
    ...
    local successFlags, combatRemoteThread =
        pcall(
        function()
